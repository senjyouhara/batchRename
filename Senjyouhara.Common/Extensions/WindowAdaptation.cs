...
namespace Senjyouhara.Common.Extensions
{
    ...
    public class WindowAdaptation
    {
        ...
        public static readonly DependencyProperty WidthByScreenRatioProperty = DependencyProperty.RegisterAttached(
            ...
            new PropertyMetadata(1.0, OnWidthByScreenRatioPropertyChanged));

        private static void OnWidthByScreenRatioPropertyChanged(DependencyObject d,
        ...
        public static readonly DependencyProperty HeightByScreenRatioProperty = DependencyProperty.RegisterAttached(
            ...
            new PropertyMetadata(1.0, OnHeightByScreenRatioPropertyChanged));

        private static void OnHeightByScreenRatioPropertyChanged(DependencyObject d,
            DependencyPropertyChangedEventArgs e)
        {
